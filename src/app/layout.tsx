  ...
  return (
    <html lang="en" className="h-full">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Italiana&family=Parisienne&family=Poppins:ital,wght@0,400;0,700;1,400&family=Roboto:wght@400;700&family=Shadows+Into+Light+Two&display=swap"
          rel="stylesheet"
        />
      </head>
