    ...
    <>
      ...
      <div className="bg-[#2a2f28] text-white py-16 md:py-20">
        <div className="container mx-auto px-4 text-center flex flex-col items-center">
            ...
            <div className="flex flex-row items-center justify-center gap-8 sm:gap-12 w-full max-w-4xl">
                <div className="flex flex-col items-center gap-2 text-center">
                    <Image src="https://content-provider.payshia.com/tea-jar/ethically-grown.webp" alt="Ethically Grown" width={80} height={80} className="object-contain h-14 sm:h-20" />
                    <h3 className="font-headline text-base sm:text-xl text-neutral-100">Ethically Grown</h3>
                </div>
                <div className="flex flex-col items-center gap-2 text-center">
                    <Image src="https://content-provider.payshia.com/tea-jar/hand-picked.webp" alt="Hand Picked" width={80} height={80} className="object-contain h-14 sm:h-20" />
                    <h3 className="font-headline text-base sm:text-xl text-neutral-100">Hand Picked</h3>
                </div>
                <div className="flex flex-col items-center gap-2 text-center">
                    <Image src="https://content-provider.payshia.com/tea-jar/factory-fresh.webp" alt="Factory Fresh" width={80} height={80} className="object-contain h-14 sm:h-20" />
                    <h3 className="font-headline text-base sm:text-xl text-neutral-100">Factory Fresh</h3>
                </div>
            </div>
        </div>
      </div>
