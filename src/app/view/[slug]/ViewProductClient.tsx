...
export function ViewProductClient({ product }: ViewProductClientProps) {
    ...
    return (
      <div className="bg-[#1a2e23] text-white min-h-screen w-full">
        <AnimatePresence mode="wait">
          {selectedLang ? (
            ...
            <motion.div
              ...
              exit={{ opacity: 0 }}
              transition={{ duration: 0.5, ease: 'easeInOut' }}
              className="min-h-screen flex flex-col items-center justify-center p-4 pt-32 pb-12"
            >
              ...
              <div className="w-full max-w-sm text-center">
                ...
                <h2 className="font-headline text-3xl md:text-4xl text-amber-100/90 mt-6 mb-8">
                  {product.name}
                </h2>
              </div>
